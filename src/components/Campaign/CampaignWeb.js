            ...
            <AnimateGroup play>
               ...
               <div className=" VideoPure">
                  <div className="row justify-content-center VidPureWeb">
                     ...
                     <div className="col-6">
                        ...
                        <iframe title="vimeo-player" src="https://player.vimeo.com/video/552619675" className="VidPure " /* width="640" height="360" */ frameborder="0" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
               ...
               <div className=" VideoPurify">
                  <div className="row justify-content-center rowPurify VidPurifyWeb" style={{padding:"0% 0%"}}>
                     ...
                     <iframe title="vimeo-player" src="https://player.vimeo.com/video/552620016" className="VidPurify" /* width="640" height="360" */ frameborder="0" allowfullscreen></iframe>
                     </div>
                  </div>
               </div>
               <Animate 
