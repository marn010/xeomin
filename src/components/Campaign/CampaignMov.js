         ...
         <React.Fragment>
            <div className="CampaignMainBox CampaignMov">
               ...
               <div className="container col-12 justify-content-center Raleway font24">
                  <div className="row">
                     <div className="col-12 MerzAestheticsTextWBox" style={{paddingTop:"5%"}}>
                     <p>
               ...
               <div className="container col-12">
                  <div className="row font24">
                     <div className="col-12 MerzAestheticsTextWBox Raleway ">
                        <p>
               ...
               <div className=""> 
                  <img className="GPAbout" src="/assets/img/Pics/GPAboutMov.png" alt="" />
               </div>
            </div>
         </React.Fragment>
      );
